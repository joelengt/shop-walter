...
Route::match(['get','post'],'/admin/slider-imagen/{id_slider}/editar/{id_slider_imagen}',['uses' => 'SlidersImagenesControlador@EditarImagenSlider','as' => 'editar-slider-imagen-admin']);
Route::match(['get','post'],'/admin/slider-imagen/{id_slider}/agregar',['uses' => 'SlidersImagenesControlador@AgregarImagenSlider','as' => 'agregar-slider-imagen-admin']);
...
Route::get('/clientes',['uses' => 'TiendaControlador@Clientes','as' => 'clientes']);
Route::get('/lista-precios',['uses' => 'TiendaControlador@ListaPrecios','as' => 'lista-precios']);