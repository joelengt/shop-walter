    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <form name="editar-licencia" id="editar-licencia" style="font-size: 11px;" class="form-horizontal" action="{{ route('editar-usuarios-admin',['id_usuario'=>$usuario->id_usuario]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-xs-12 col-md-6 input-group-sm">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control input-sm" id="username" name="username" value="{{ $usuario->username }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-xs-12 col-md-6 input-group-sm">
                            ...
                            <div class="col-md-7">
                                <select class="form-control input-sm" name="id_perfil" id="id_perfil">
                                    ...
                                    <option value="{{ $perfil->id_perfil }}" @if($perfil->id_perfil==$usuario->id_perfil) selected="" @endif >{{ $perfil->nombre_perfil }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-xs-12 col-md-6 input-group-sm">
                            ...
                            <div class="col-md-7">
                                <select class="form-control input-sm" name="habilitado" id="habilitado">
                                    ...
                                    <option value="1" @if($usuario->habilitado==1) selected="" @endif>Si</option>
                                    <option value="0" @if($usuario->habilitado==0) selected="" @endif>No</option>
                                </select>
                            </div>
                        </div>
