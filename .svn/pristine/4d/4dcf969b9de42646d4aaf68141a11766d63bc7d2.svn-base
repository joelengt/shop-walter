...
--
-- Servidor: localhost
-- Tiempo de generación: 01-08-2016 a las 17:16:37
...
CREATE TABLE `galerias` (
  ...
  `nombre_galeria` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `habilitado` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `galerias_imagenes` (
  `id_galeria_imagen` int(10) UNSIGNED NOT NULL,
  `id_galeria` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `galerias_productos`
--

CREATE TABLE `galerias_productos` (
  `id_galeria_producto` int(10) UNSIGNED NOT NULL,
  `id_galeria` int(10) UNSIGNED NOT NULL,
...
--
-- Indices de la tabla `galerias_imagenes`
--
ALTER TABLE `galerias_imagenes`
  ADD PRIMARY KEY (`id_galeria_imagen`),
  ADD KEY `galerias_imagenes_id_galeria_foreign` (`id_galeria`),
  ADD KEY `galerias_imagenes_id_imagen_foreign` (`id_imagen`);

--
-- Indices de la tabla `galerias_productos`
--
ALTER TABLE `galerias_productos`
  ADD PRIMARY KEY (`id_galeria_producto`),
  ADD KEY `galerias_productos_id_galeria_foreign` (`id_galeria`),
  ADD KEY `galerias_productos_id_producto_foreign` (`id_producto`);
...
--
ALTER TABLE `carruseles`
  MODIFY `id_carrusel` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `especificaciones`
  MODIFY `id_especificacion` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `galerias`
--
ALTER TABLE `galerias`
  MODIFY `id_galeria` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `galerias_imagenes`
--
ALTER TABLE `galerias_imagenes`
  MODIFY `id_galeria_imagen` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `galerias_productos`
--
ALTER TABLE `galerias_productos`
  MODIFY `id_galeria_producto` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `productos_carruseles`
  MODIFY `id_producto_carrusel` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `productos_categorias`
--
ALTER TABLE `productos_categorias`
  MODIFY `id_producto_categoria` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `productos_colores`
--
ALTER TABLE `productos_colores`
  MODIFY `id_producto_color` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `productos_especificaciones`
--
ALTER TABLE `productos_especificaciones`
  MODIFY `id_producto_especificacion` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `categorias_marcas`
  ADD CONSTRAINT `categorias_marcas_id_categoria_foreign` FOREIGN KEY (`id_categoria`) REFERENCES `categorias` (`id_categoria`),
  ADD CONSTRAINT `categorias_marcas_id_marca_foreign` FOREIGN KEY (`id_marca`) REFERENCES `marcas` (`id_marca`);

--
-- Filtros para la tabla `galerias_imagenes`
--
ALTER TABLE `galerias_imagenes`
  ADD CONSTRAINT `galerias_imagenes_id_galeria_foreign` FOREIGN KEY (`id_galeria`) REFERENCES `galerias` (`id_galeria`),
  ADD CONSTRAINT `galerias_imagenes_id_imagen_foreign` FOREIGN KEY (`id_imagen`) REFERENCES `imagenes` (`id_imagen`);

--
-- Filtros para la tabla `galerias_productos`
--
ALTER TABLE `galerias_productos`
  ADD CONSTRAINT `galerias_productos_id_galeria_foreign` FOREIGN KEY (`id_galeria`) REFERENCES `galerias` (`id_galeria`),
  ADD CONSTRAINT `galerias_productos_id_producto_foreign` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`);

--
-- Filtros para la tabla `productos_carruseles`
--
ALTER TABLE `productos_carruseles`
  ADD CONSTRAINT `productos_carruseles_id_carrusel_foreign` FOREIGN KEY (`id_carrusel`) REFERENCES `carruseles` (`id_carrusel`),
  ADD CONSTRAINT `productos_carruseles_id_producto_foreign` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`);

--
-- Filtros para la tabla `productos_categorias`
--
ALTER TABLE `productos_categorias`
  ADD CONSTRAINT `productos_categorias_id_categoria_foreign` FOREIGN KEY (`id_categoria`) REFERENCES `categorias` (`id_categoria`),
  ADD CONSTRAINT `productos_categorias_id_producto_foreign` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`);

--
-- Filtros para la tabla `productos_colores`
--
ALTER TABLE `productos_colores`
  ADD CONSTRAINT `productos_colores_id_color_foreign` FOREIGN KEY (`id_color`) REFERENCES `colores` (`id_color`),
  ADD CONSTRAINT `productos_colores_id_producto_foreign` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`);

--
-- Filtros para la tabla `productos_especificaciones`
--
ALTER TABLE `productos_especificaciones`
  ADD CONSTRAINT `productos_especificaciones_id_especificacion_foreign` FOREIGN KEY (`id_especificacion`) REFERENCES `especificaciones` (`id_especificacion`),
  ADD CONSTRAINT `productos_especificaciones_id_producto_foreign` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`);
