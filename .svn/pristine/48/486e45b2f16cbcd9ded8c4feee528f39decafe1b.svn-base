...
--
-- Servidor: localhost
-- Tiempo de generación: 05-08-2016 a las 17:02:19
...
(1, 'STARK', 'Boligrafo con cuerpo solid. Retráctil. Trazo 1.0 mm. Cartucho Tipo Parker.', 0, 0.00, 'stark', '2016-08-02', 1, 1, '2016-08-02 00:00:00', '2016-08-04 12:44:46', 1),
...
(1, 'admin', 'a6f30815a43f38ec6de95b9a9d74da37', 1, 1, '0MYwQyKrvIQDe5nwUJaYITu3iYV9pje6xAfcmovuIJSYak8GyVqOsb3PHRyd');
...
--
ALTER TABLE `imagenes`
  MODIFY `id_imagen` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
--
...
--
ALTER TABLE `productos_carruseles`
  MODIFY `id_producto_carrusel` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT de la tabla `productos_categorias`
--
ALTER TABLE `productos_categorias`
  MODIFY `id_producto_categoria` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT de la tabla `productos_colores`
--
ALTER TABLE `productos_colores`
  MODIFY `id_producto_color` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
--
-- AUTO_INCREMENT de la tabla `productos_especificaciones`
--
ALTER TABLE `productos_especificaciones`
  MODIFY `id_producto_especificacion` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
--
-- AUTO_INCREMENT de la tabla `productos_imagenes`
--
ALTER TABLE `productos_imagenes`
  MODIFY `id_producto_imagen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
