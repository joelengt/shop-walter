            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                        ...
                        <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                            ...
                            <button class="btn btn-primary btn-xs" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="AgregarColores()">Agregar color</button>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover table-condensed table-striped" role="grid" aria-describedby="example2_info">
                                        ...
                                        @foreach($colores as $color)
                                            <tr role="row" class="odd">
                                                <td>
                                                    <span class="glyphicon glyphicon-pencil" aria-hidden="true" onclick="EditarColores({{ $color->id_color }})"></span>
                                                    
                                                    <span class="glyphicon glyphicon-remove" aria-hidden="true" onclick="EliminarColor({{ $color->id_color }})"></span>
