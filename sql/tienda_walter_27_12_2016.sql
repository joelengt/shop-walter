...
--
-- Servidor: localhost
-- Tiempo de generación: 27-12-2016 a las 18:06:37
...
(158, 'productos/TTcm7G1qp55VWqKphQvdZLIGHYaLVidliI1917TE.gif', 1),
(159, 'productos/Cpi781hOKsFgVjrdkG2lQut40I6kjafUNvE34rJq.gif', 1),
(160, 'productos/iJH7WRc50c1yRuTq8eVoUedkPRTdF4mppHNTrKzJ.gif', 1),
(161, 'productos/6y7TSZxt8X0NvphXDhXPcDtTAW07j72CfRQA7WRI.gif', 1),
(162, 'productos/VwDrIp5ycnocmrZDtExBKraR20WgbX6Xf1PpVVRo.gif', 1);
...
('2016_12_10_101516_create_jobs_table', 2),
('2016_12_10_105100_create_failed_jobs_table', 3);
...
(51, 'Tapa cuaderno', 'Tapa cuaderno', 0, 0.00, 'tapa-cuaderno', '2016-12-27', 1, NULL, '2016-12-27 10:46:23', '0000-00-00 00:00:00', 1),
(52, 'Calendario Bolsillo', '', 0, 0.00, 'calendario-bolsillo', '2016-12-27', 1, NULL, '2016-12-27 10:48:12', '0000-00-00 00:00:00', 1),
(53, 'Tarjeta', 'tarjeta', 0, 0.00, 'tarjeta', '2016-12-27', 1, NULL, '2016-12-27 10:50:06', '0000-00-00 00:00:00', 1),
(54, 'Individual', 'individual', 0, 0.00, 'individual', '2016-12-27', 1, NULL, '2016-12-27 11:05:38', '0000-00-00 00:00:00', 1),
(55, 'Padmouse', 'padmouse', 0, 0.00, 'padmouse', '2016-12-27', 1, NULL, '2016-12-27 11:06:43', '0000-00-00 00:00:00', 1);
...
INSERT INTO `sliders_imagenes` (`id_slider_imagen`, `id_slider`, `id_imagen`, `habilitado`, `url`) VALUES
(1, 1, 97, 1, 'productos/tecnologia/selfie-stick/selfie-stick'),
(2, 1, 98, 1, 'productos/microinyectado/posavasos/barmat');
...
(1, 'admin', 'a6f30815a43f38ec6de95b9a9d74da37', 1, 1, 'sSf8yY2q5shNEEzMcor8K1e11biGONvFuMMUNj2faGX7nuXiXwK9KiDMz2DF');
...
--
ALTER TABLE `imagenes`
  MODIFY `id_imagen` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=163;
--
...
--
ALTER TABLE `productos`
  MODIFY `id_producto` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
--
...
--
ALTER TABLE `productos_categorias`
  MODIFY `id_producto_categoria` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
--
-- AUTO_INCREMENT de la tabla `productos_colores`
--
ALTER TABLE `productos_colores`
  MODIFY `id_producto_color` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=254;
--
-- AUTO_INCREMENT de la tabla `productos_especificaciones`
--
ALTER TABLE `productos_especificaciones`
  MODIFY `id_producto_especificacion` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=189;
--
-- AUTO_INCREMENT de la tabla `productos_imagenes`
--
ALTER TABLE `productos_imagenes`
  MODIFY `id_producto_imagen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
--
